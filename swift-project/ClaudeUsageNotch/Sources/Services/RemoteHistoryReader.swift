...
struct RemoteAnalytics: Decodable {
    ...
    struct HourlyValueDTO: Decodable {
        let hour:  Int
        let value: Double
    }
    ...
    let hourlyActivity:   [HourlyValueDTO]
    ...
    func toAnalyticsData() -> AnalyticsData {
        return AnalyticsData(
            ...
            hourlyActivity:   hourlyActivity.map { HourlyValue(hour: $0.hour, value: $0.value) },
...
enum RemoteHistoryReader {
    ...
    static func fetchAnalytics(
        ...
        components?.queryItems = [
            ...
            URLQueryItem(name: "session_cost_since", value: iso8601Millis.string(from: sessionCostSince)),
