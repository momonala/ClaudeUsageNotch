...
#   REPO         owner/name for releases (default momonala/ClaudeUsageNotch)
#   TAP_REPO     owner/homebrew-name     (default momonala/homebrew-claude-usage-notch)
#   CASK         cask file basename      (default claude-usage-notch)
#
...
REPO="${REPO:-momonala/ClaudeUsageNotch}"
TAP_REPO="${TAP_REPO:-momonala/homebrew-claude-usage-notch}"
CASK="${CASK:-claude-usage-notch}"
